...
-(void) customerLoginWithParam:(NSDictionary *)paramDic responseBlock:(void(^)(eResponseType type, id userProfile))responseBlock;

#pragma mark - customerLoginWithParam
